        ...
        return (
            <div className="main-banner digital-agency-banner">
                            ...
                            <div className="row h-100 align-items-center">
                                <div className="col-lg-6 col-md-12">
                                    <div className="hero-content">
                                        ...
                                        <a href="/contact" className="btn btn-primary wow fadeInLeft">Get Started</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="circle-shape1">
                    <img src="/images/shapes/circle1.png" alt="shape" className="w-150" />
                </div>
                <div className="circle-shape2">
                    <img src="/images/shapes/circle2.png" alt="shape" className="w-150" />
                </div>
            </div>
        );
    }
